...
# get current directory with os.getcwd() and assign to variable
...
path = current_directory + "/" + args.path
host = args.host
rootCAPath = current_directory + "/" + args.rootCAPath
certPath = current_directory + "/" + args.certPath
keyPath = current_directory + "/" + args.keyPath
